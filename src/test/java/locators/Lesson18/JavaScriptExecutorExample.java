...
public class JavaScriptExecutorExample extends BaseTest {
    ...
    public void jsExecutor() throws InterruptedException {
        webDriver.get("http://the-internet.herokuapp.com/infinite_scroll");
    ...
    public void jsClick() throws InterruptedException {
        ...
        JavascriptExecutor javascriptExecutor = (JavascriptExecutor) webDriver;
        WebElement bookStore = webDriver.findElement(By.xpath("//body/div[@id='app']/div[@class='body-height']/div[@class='container playgound-body']/div[@class='row']/div[1]/div[1]/div[1]/div[6]/span[1]/div[1]/div[2]"));
//       bookStore.click();
